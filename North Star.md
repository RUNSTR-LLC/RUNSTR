...
RUNSTR offers two subscription tiers for users who want more. The Supporter tier significantly increases your per-workout rewards and unlocks access to premium competitions. The Pro tier includes everything in Supporter plus the ability to create and manage a Fitness Club. The subscription is framed as a fitness bet — work out three times a week to break even, five times a week to profit. RUNSTR bets you won't keep it up.

Fitness Clubs are the social layer of the app, available to Pro subscribers. When you create a club, you get a dedicated page with a member leaderboard, real-time chat, and the ability to host events. Captains can create competitions from templates — 5K races, 10K challenges, half marathons, step challenges — and all club members are automatically entered. Captains earn rewards for each club member workout, and the roadmap includes enabling clubs to create their own reward pools and event prize pools by connecting an NWC wallet — giving captains a non-custodial way to reward their members directly.
...
RUNSTR is a fitness company that hosts events, builds community through Fitness Clubs, and rewards people for moving. It monetizes through subscriptions, sponsorships, and event ticket sales. The app is designed to stay out of your way — three tabs, dark theme, no gimmicks. Private Mode lets you track workouts locally without participating in anything. Whether you're competing for the fastest 5K of the day or just logging your evening walk, RUNSTR meets you where you are and makes sure your effort counts for something.
...
- **Fitness company, not a crypto app** — RUNSTR hosts events, sells subscriptions, and partners with sponsors. The underlying technology is invisible to users.
...
| Revenue Stream | How |
|---|---|
| **Subscriptions** | Supporter and Pro tiers |
