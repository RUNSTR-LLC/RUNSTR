...
Components for the Advanced Analytics Screen (Stats tab).
...
- **HealthSnapshotCard.tsx** - BMI, VO2 Max, Fitness Age metrics
- **HolisticHealthScoreCard.tsx** - Overall health score calculation
- **WeeklySummaryAccordion.tsx** - Collapsible weekly workout summary
