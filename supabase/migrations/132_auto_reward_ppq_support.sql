-- Migration: Add PPQ.AI bolt11 support to auto-reward trigger
-- Purpose: PPQ.AI users earn AI credits via bolt11 invoices instead of Lightning addresses.
--          The trigger must read ppq_bolt11 from the workout_submissions row and pass it
--          to claim-reward so the invoice gets paid.
-- Date: 2026-02-08

-- Replace the trigger function with PPQ.AI support
