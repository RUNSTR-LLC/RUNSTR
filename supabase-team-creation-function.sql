-- Supabase Stored Procedure: create_team_with_captain
-- Atomically creates a team and ensures the captain user exists
-- This addresses the foreign key constraint issue by handling everything in one transaction
